...
namespace Kehlet.SignalR;

public static class HubConnectionExtensions
{
    private static IDisposable On<TClient>(HubConnection connection, TClient client, LambdaExpression handler)
    {
        ...
        return (IDisposable) genericOnMethod.Invoke(null, [connection, methodName, handlerDelegate])!;
    }
